...
function WACCClient(s_ServerPath, b_IsHidden, s_ParentID, s_PromptText, i_ConsoleHeight)
{
  ...
  o_Prompt = $('<label/>', {id: 'prompt', for: 'command-line'}).text(this.s_PromptText);
